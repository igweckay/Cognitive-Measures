...
import edu.usc.cognitive.reasoning.ARIntro_Activity;
import edu.usc.cognitive.vocab.VO11_Activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivity.this, VO11_Activity.class);
