...
public class Set5Item2_Activity extends Activity {
	boolean click = false; int count=0;long ms;boolean empty=false;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_set5_item2_);
		Date start = new Date();
		String s = MyGlobalVariables.getTime();
		s+="nsa52_start:"+start.toString()+";";
		...
		new CountDownTimer(60000, 1000) {
		     ...
		     public void onTick(long millisUntilFinished) {
		    	...
		    	else if(click && !empty)
		    	{
	        		...
	        		Date end = new Date();
	          		String s = MyGlobalVariables.getTime();
	          		s+="nsa52_end:"+end.toString()+";";
	          		MyGlobalVariables.setTime(s);
		    		Intent intent = new Intent(Set5Item2_Activity.this, Set5Item3_Activity.class);
...
//         	    startActivity(intent);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		Log.d("Set5Item2",  "onActivityResult - Set5Item2_Activity");
		if (requestCode == 1) {
