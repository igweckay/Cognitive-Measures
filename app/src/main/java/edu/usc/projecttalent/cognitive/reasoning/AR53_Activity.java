...
public class AR53_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    myImage.setImageBitmap(ImageDecoder.decodeImage(getResources(),R.drawable.ar_12_main,myImage.getLayoutParams().width,myImage.getLayoutParams().height));

	    myImage = (ImageView) findViewById(R.id.imageView1);
	    myImage.setImageBitmap(ImageDecoder.decodeImage(getResources(),R.drawable.ar_12_1,myImage.getLayoutParams().width,myImage.getLayoutParams().height));

	    myImage = (ImageView) findViewById(R.id.imageView2);
	    myImage.setImageBitmap(ImageDecoder.decodeImage(getResources(),R.drawable.ar_12_2,myImage.getLayoutParams().width,myImage.getLayoutParams().height));

	    myImage = (ImageView) findViewById(R.id.imageView3);
	    myImage.setImageBitmap(ImageDecoder.decodeImage(getResources(),R.drawable.ar_12_3,myImage.getLayoutParams().width,myImage.getLayoutParams().height));

	    myImage = (ImageView) findViewById(R.id.imageView4);
	    myImage.setImageBitmap(ImageDecoder.decodeImage(getResources(),R.drawable.ar_12_4,myImage.getLayoutParams().width,myImage.getLayoutParams().height));

	    myImage = (ImageView) findViewById(R.id.imageView5);
	    myImage.setImageBitmap(ImageDecoder.decodeImage(getResources(),R.drawable.ar_12_5,myImage.getLayoutParams().width,myImage.getLayoutParams().height));
		...
		quitButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				recordEndTime();
				Intent intent = new Intent(AR53_Activity.this, FinishActivity.class);
  ...
  button.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
      	...
      	if((click && count>=2)){
    		...
    		Intent intent=null;
			//create_textfile();
    		intent = new Intent(AR53_Activity.this, FinishActivity.class);
			startActivityForResult(intent,1);
      	}
      }
  });
		...
		new CountDownTimer(25000, 1000) {
			...
			public void onFinish() {
				if(!click & !exit ){
					//On finishing the 180 seconds, take the user to Quit/Resume activity.
					recordEndTime();
					Intent intent = new Intent(AR53_Activity.this, ARIntro_Activity.class);
					startActivityForResult(intent,1);
				}
			}
		}.start();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		Log.d("AR53",  "onActivityResult - AR53");
		if (requestCode == 1) {
