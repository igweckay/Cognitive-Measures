...
public class VO51_Activity extends AppCompatActivity {
    long ms;
    boolean click = false;
    boolean empty=false;
    int count=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vo51_);

        Date start = new Date();
        String s = MyGlobalVariables.getTime();
        //s+="sec_vo_start:"+start.toString()+";";
        s+="vo51_start:"+start.toString()+";";
        ...
        quitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                recordEndTime();
                Intent intent = new Intent(VO51_Activity.this, FinishActivity.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (s.contains("vo51_score:")){
                    p=s.indexOf("vo51_score:");
                    s = s.substring(0,p);
                }
                if (s.contains("vo51_ans:")){
                    p=s.indexOf("vo51_ans:");
                    s = s.substring(0,p);
                }
                ...
                if (selectedId == -1)
                {
                    ...
                    s+="vo51_score:"+Integer.toString(MyGlobalVariables.qx1)+";";
                    s+="vo51_ans:1;";
...
//                    u = string.substring(string.length() - 1));
                ...
                if((click && count>=2)){
                    ...
                    recordEndTime();
                    Intent intent = new Intent(VO51_Activity.this, VO52_Activity.class);
                    startActivityForResult(intent,1);
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("VO51",  "onActivityResult - VO51_Activity");
        if (requestCode == 1) {
