...
public class SWset32_Activity extends Activity {
	...
	boolean[] click={false,false,false,false,false};CountDownTimer n;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_swset32_);
	                ...
	                // Perform action on click
	            		...
	            		if(i==seq.length-1){
	            			String s = MyGlobalVariables.getData();
	                   		if (s.contains("swset32:")){
	                   			int p=s.indexOf("swset32:");
	                   			s = s.substring(0,p);
	                   		}
	                   		s+="swset32:"+Integer.toString(score)+";";
	                   		MyGlobalVariables.setData(s);
	                   		MyGlobalVariables.setMissItem(miss);
	            			Intent intent = new Intent(SWset32_Activity.this, SWsetNorm2_Activity.class);
