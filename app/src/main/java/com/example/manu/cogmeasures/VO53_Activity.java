...
public class VO53_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                recordEndTime();
                Intent intent = new Intent(VO53_Activity.this, FinishActivity.class);
...
//                    u = string.substring(string.length() - 1));
                ...
                if((click && count>=2)){
                    ...
                    intent = new Intent(VO53_Activity.this, FinishActivity.class);
                    startActivityForResult(intent,1);
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("VO53",  "onActivityResult - VO53_Activity");
        if (requestCode == 1) {
