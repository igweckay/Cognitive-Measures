...
public class VO13_Activity extends AppCompatActivity {
    long ms;
    boolean click = false;
    boolean empty=false;
    int count=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vo13_);

        Date start = new Date();
        String s = MyGlobalVariables.getTime();
        //s+="sec_vo_start:"+start.toString()+";";
        s+="vo13_start:"+start.toString()+";";
        ...
        quitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                recordEndTime();
                Intent intent = new Intent(VO13_Activity.this, FinishActivity.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (s.contains("vo13_score:")){
                    p=s.indexOf("vo13_score:");
                    s = s.substring(0,p);
                }
                if (s.contains("vo13_ans:")){
                    p=s.indexOf("vo13_ans:");
                    s = s.substring(0,p);
                }
                ...
                if (selectedId == -1)
                {
                    ...
                    s+="vo13_score:"+Integer.toString(MyGlobalVariables.qx3)+";";
                    s+="vo13_ans:4;";
                ...
                if((click && count>=2)){
                    ...
                    Intent intent=null;
                    //create_textfile();
                    //intent = new Intent(VO13_Activity.this, SecNS_Activity.class);
                    intent = new Intent(VO13_Activity.this, FinishActivity.class);
                    startActivityForResult(intent,1);
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("VO13",  "onActivityResult - VO13_Activity");
        if (requestCode == 1) {
