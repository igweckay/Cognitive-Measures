...
public class SecSWset2_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sec_swset2_);
		Date start = new Date();
   		String s = MyGlobalVariables.getData();
   		s+="swset2_start:"+start.toString()+";";
		  ...
		  button1.setOnClickListener(new View.OnClickListener() {
	            public void onClick(View v) {
	                // Perform action on click	
	            		...
	            		if(i==seq.length-1){
	            			String s = MyGlobalVariables.getData();
	                   		if (s.contains("swset2:")){
	                   			int p=s.indexOf("swset2:");
	                   			s = s.substring(0,p);
	                   		}
	                   		s+="swset2:"+Integer.toString(score)+";";
	                   		MyGlobalVariables.setData(s);
	                   		Date end = new Date();
	                   		s = MyGlobalVariables.getData();
	                   		s+="swset2_end:"+end.toString()+";";
	                   		MyGlobalVariables.setData(s);
	            			Intent intent = new Intent(SecSWset2_Activity.this, SecSWMixedIntro_Activity.class);
	            ...
	            public void onClick(View v) {
	                // Perform action on click	
	            		...
	            		String s = MyGlobalVariables.getData();
                   		...
                   		s+="swset2_end:"+end.toString()+";";
                   		MyGlobalVariables.setData(s);
            			Intent intent = new Intent(SecSWset2_Activity.this, SecSP_Activity.class);
	            	    startActivity(intent);
	            }
	        });
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sec_swset2_, menu);
		return true;
	}
	@Override
