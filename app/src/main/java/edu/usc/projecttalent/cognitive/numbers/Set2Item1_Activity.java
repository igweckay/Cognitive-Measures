...
public class Set2Item1_Activity extends Activity {
	boolean click = false; int count=0;long ms;boolean empty=false;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_set2_item1_);
		Date start = new Date();
		String s = MyGlobalVariables.getTime();
		s+="nsa21_start:"+start.toString()+";";
		...
		new CountDownTimer(60000, 1000) {
		     ...
		     public void onTick(long millisUntilFinished) {
		    	...
		    	else if(click && ! empty)
		    	{
	        		...
	        		Date end = new Date();
	        		String s = MyGlobalVariables.getTime();
	        		s+="nsa21_end:"+end.toString()+";";
	        		MyGlobalVariables.setTime(s);
		    		Intent intent = new Intent(Set2Item1_Activity.this, Set2Item2_Activity.class);
...
//         	    startActivity(intent);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		Log.d("Set2Item1",  "onActivityResult - Set2Item1_Activity");
		if (requestCode == 1) {
